    ...
    <div class="row">
        ...
        <table class="table table-hover"> 
	        <thead class="thead-dark">
             ...
             <th>Descripción</th>
             <th>
             <a class="btn btn-success btn-lg btn-block btn-table" href="formularios/agregar/Create.php">
            ...
            <tbody>
             <tr>
                ...
                <div class="row">
                <div class="col-sm">
                 <a href="metodos/eliminar/Delete.php" class="btn btn-danger btn-lg btn-block btn-table">
                  ...
                  <div class="col-sm">
                 <a href="formularios/editar/Edit.php" class="btn btn-warning btn-lg btn-block btn-table">
